  ...
  <nav class="navbar navbar-inverse">
    <div class="navbar-header">
      ...
      <h1><a class="navbar-brand" href="<?= base_url('admin/dashboard'); ?>"> 
        ...
        <img class="img-responsive" style="display: inline-block; width: 30px; vertical-align: sub; margin-top: 7px;" src="<?php echo base_url('/assets/logo.png'); ?>" height="20" width="20"> MyParty App</a></h1>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('admin/providerList'); ?>"><i class="fa fa-angle-right"></i> Provider List</a></li>
          </ul>
        </li>   
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('admin/category_list'); ?>"><i class="fa fa-angle-right"></i>Category List</a></li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('admin/payment_list'); ?>"><i class="fa fa-angle-right"></i> Payment History</a></li>
          </ul>
        </li>  
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('admin/event_list'); ?>"><i class="fa fa-angle-right"></i> Event List</a></li>
          </ul>
        </li>  
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('admin/note_list'); ?>"><i class="fa fa-angle-right"></i> Note List</a></li>
          </ul>
        </li>  
